...
types = ["ReLU", "Linear", "Conv2d", "AvgPool2d", "LinearReLU", "Conv_Avg_Pool2d", "Dct2_2d", "Dft_2d"]
...
def randomLayer():
	...
	elif type1 in ["Conv2d", "Conv_Avg_Pool2d"]: # 如果是 Conv2d 或 ConvPool2d
...
types2d = ["Conv2d", "Conv_Avg_Pool2d", "AvgPool2d", "Flatten", "Dct2_2d", "Dft_2d"]
